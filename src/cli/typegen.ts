...
import type { PostboiDomain } from "./postboi.js"
 ...
 *   account's sending address plus its domains, and every WhatsApp `template` to the
 *   names approved on Meta or Twilio. Pending domains are included
...
const HEADER =
	"// Generated by `bunx postboi sync` — do not edit. Re-run it after a domain or template changes.\n"
 ...
 * sending addresses and no templates.
 */
...
/** Read back the `from:` union {@link member} wrote, so a run without domains keeps it. */
