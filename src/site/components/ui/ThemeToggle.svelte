<script lang="ts">
	...
	import { themeStore } from "$site/stores/theme.svelte"
...
<button
	type="button"
	class={cn(
		"group key relative inline-flex size-7 items-center justify-center rounded-sm bg-background-muted text-foreground",
		className
	)}
